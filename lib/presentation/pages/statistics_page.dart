                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            profitToString(sessionsProfit(state.sessionsFromPeriod)),
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                '${(countGames(state.sessionsFromPeriod) / state.sessionsFromPeriod.length).floor()} games',
                                style: AppTextStyles.font24,
                              ),
                            ],
                          ),
                        ...
                        for (var game in statisticsGames(state.sessionsFromPeriod))
                          Padding(
                            ...
                            child: StatisticsGameContainer(
                              ...
                              profit: profitToString(game['profit']),
                              image: game['image'],
                            ),
                          ),
                      ],
